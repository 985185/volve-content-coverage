...
- Which wells contain structured daily drilling reports?
...
4. Use existing catalog tags to classify files into petroleum-relevant categories (for example: DDR_XML, WITSML, XML, DLIS, LAS, SEGY, WELL_TECH, DOCS, RMS_MODEL).
